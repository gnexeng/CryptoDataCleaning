...
\keywords{Cryptography, Pseudo-random number generator, Random Graphs, Simplical Complexes}
...
There is no discernable pattern from the trendlines. 
...
\includegraphics[width=\linewidth, height=0.6\linewidth]{./charts/varying-conings-v2.png}
\label{fig:conings}
\end{figure}
...
\includegraphics[width=\linewidth, height=0.6\linewidth]{./charts/varying-lengths-v2.png}
\label{fig:lengths}
\end{figure}
...
\includegraphics[width=\linewidth, height=0.6\linewidth]{./charts/varying-patterns-v2.png}
\label{fig:patterns}
\end{figure}
...
\bibitem[ALDH]{ALDH} Allen, D., Jos\'{e} J. La Luz, J., Salivia., G., Hardwick, J.,
