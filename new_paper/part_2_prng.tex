...
\clearpage
\indent Motivated by the failure of the NIST test suite to detect non-random phenomena a third experiment was conducted.  Here, the $h$-vector was fixed at a length of 3750 and we varied the non-end elements in the pattern from 1 to 100. The contents of the h-vector can be all-1’s, or it can be any other integer as long as the two end elements are 1. Varying the non-end elements from 1 to 100 literally means creating the following h-vectors: 
