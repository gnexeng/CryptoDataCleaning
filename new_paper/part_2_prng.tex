\documentclass[draft,oneside,12pt]{amsart}
...
\item Step 3:  Compute the $k^{th}$ cone on the $f$-vector from the previous step.  i.e., $C^k(K)$ where $K$ is the simplicial complex dual to $\Delta^n$ and $ 0 \leq k \leq q$ for some $q$. (first experiment only)
